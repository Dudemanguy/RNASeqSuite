...
aveLogCPM.DataList <- function(y, normalized.lib.sizes=TRUE, prior.count=2, dispersion=NULL, ...) {
#	log2(AveCPM)
#	Gordon Smyth
...
aveLogCPM.DataGLM <- function(y, prior.count=2, dispersion=NULL, ...) {
#	log2(AveCPM)
#	Gordon Smyth
